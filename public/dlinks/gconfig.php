...
cConfigSm::instance('global_template3', '<div class="b-sotmarket-banner mod_blue" style="width: 310px;"><div class="b-sotmarket-banner-head"></div><div class="b-sotmarket-banner-content">
...
cConfigSm::instance('global_session_id', '/redirect/,/print/,/rss/,/red/,/service/search/,/pages/informer/,/pages/ftext/,/archive/');
